    ...
    public class Home_Page extends BaseClass{
        ...
        public static class TopNavigation{
        	...
        	public static class Product_Type{
        			...
        			static WebElement ele_Accesories;
      		
        		public static void Accessories() throws Exception{
        			try{
	        			//mainElement = driver.findElement(By.linkText("Product Category"));
	        			mainElement = driver.findElement(By.cssSelector("li:contains('Product Category')"));
	        			Log.info("Product category link is found under Top Navigation");
	        			//Add by frank
	        			Actions builder=new Actions(driver);
	        			builder.moveToElement(mainElement).perform();  //will hover to product catory
	        			//mainElement.click();
	        			Log.info("Product category link is mouse over");
	        			Thread.sleep(3000);
	        			//By ele_Accesories=By.cssSelector("a:contains('Accessories')");
	        			//((Actions) driver).click(ele_Accesories);
	        			driver.findElement(By.cssSelector("a:contains('Accessories')")).click();
	        			//End of modification
	        			Log.info("Accessories link is found under Top Navigation");
